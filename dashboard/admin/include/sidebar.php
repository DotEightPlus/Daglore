...
<head>
  ...
  <title>DotEightPlus | Schoool Management Software Demo</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="./" class="brand-link">
      <img src="dist/img/logo.png" alt="Paradise Model School" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <br/>
          ...
          <br/>
          <li class="nav-item has-treeview">
            <a href="https://icbt.paradisemodelschool.com.ng"  class="nav-link">
...
<br/>
<li class="nav-item has-treeview">
            <a target="_blank" href="https://dashboard.flutterwave.com/dashboard/overview/total" class="nav-link">
